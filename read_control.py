...
def process_control_data(control_data):
    ...
    processed_data = {
        ...
        'left_long': control_data.get('Longitude range (west side)', None),
        'right_long': control_data.get('Longitude range (east side)', None),
        'south_lat': control_data.get('Latitude range (south side)', None),
